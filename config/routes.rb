ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :accounts, 
                :has_many => [:users, :collections, :events, :deletions, :tags], 
  ...
  map.resources :user_preferences, 
                :member => {:activate => :any, :deactivate => :any, :toggle => :any}
